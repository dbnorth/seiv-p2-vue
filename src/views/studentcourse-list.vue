...
export default {
    ...
    methods: {
        ...
        calcMajorHours() {
          ...
          this.studentCourses.filter(studentCourse => this.degreeCourses.includes(studentCourse.courseId))
            ...
            console.log("total hours"+ studentCourse.course)});
        },
        calcGPA() {
          let totalHours = 0;
          let totalPoints = 0;
      ...
      generatePDF() {
          ...
          doc.setFontSize(16).text("Course Plan for " + this.student.firstName +" "+this.student.lastName, 1.5, 1.0);
          doc.setFontSize(12).text(asof, 1.5, 1.2);
          doc.setFontSize(12).text(totalInfo, 1.5, 1.4);

          // create a line under heading 
          doc.setLineWidth(0.01).line(.5, 1.5, 8.0, 1.5);
 ...
 //       img.src = "../assets/oc-logo-white.png";  
          ...
          doc.addImage(img,"PNG", .5, .75, .75,.48);
